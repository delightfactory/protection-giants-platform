...
- `docs/post-transfer-stage-canonical-status-amendment.md` — latest authoritative implementation status after completion of the Transfer stage; this controls where older F/G/H status wording is stale;
