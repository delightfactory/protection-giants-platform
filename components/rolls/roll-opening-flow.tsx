      ...
      <div className={styles.flow}>
        <section className={styles.successCard} aria-live="polite">
          ...
          <div className={styles.nextNote}>
            ...
            <p>{taskHref
              ? "ارجع إلى نفس مهمة التنفيذ بعد فتح الرول. إذا ظهر عيب قبل التركيب، سجّل البلاغ على هذا الرول نفسه قبل متابعة المهمة."
              : "إذا كان الرول سليمًا وتم التركيب للعميل، انتقل لتفعيل الضمان على نفس الرول. وإذا ظهر عيب قبل التفعيل، سجّل بلاغ ما قبل التركيب أولًا."}</p>
          </div>
