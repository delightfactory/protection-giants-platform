...
export default async function WarrantyDetailPage({ params }: WarrantyDetailPageProps) {
  ...
  return (
    <>
      ...
      <section className="ui-detail-card" aria-label="حالة الضمان">
        <div className="ui-detail-card-header">
          <div>
            <span className="ui-detail-eyebrow">الحالة</span>
      ...
      <section className="ui-detail-card" aria-label="بيانات العميل">
        <div className="ui-detail-card-header"><h2>العميل</h2></div>
        <dl className="ui-detail-grid">
      ...
      <section className="ui-detail-card" aria-label="بيانات السيارة">
        <div className="ui-detail-card-header"><h2>السيارة</h2></div>
        <dl className="ui-detail-grid">
      ...
      <section className="ui-detail-card" aria-label="المنتج والرول">
        <div className="ui-detail-card-header"><h2>المنتج والرول</h2></div>
        <dl className="ui-detail-grid">
      ...
      <section className="ui-detail-card" aria-label="سياسة الضمان المثبتة">
        <div className="ui-detail-card-header">
          <div>
            <span className="ui-detail-eyebrow">Snapshot وقت التفعيل</span>
            <h2>سياسة الضمان والعناية</h2>
          </div>
        </div>
        <div className="ui-detail-prose">
          <h3>التغطية</h3>
