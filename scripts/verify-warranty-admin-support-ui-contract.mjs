...
includes(support, "ConfirmSubmitButton", "Void-in-error must require an explicit irreversible confirmation dialog.");
includes(support, "لا توجد له عملية Restore", "Admin support copy must explain that void has no restore path.");
includes(support, "لا يوجد Restore إلى issued", "Confirmation must explicitly state there is no restore to issued.");
